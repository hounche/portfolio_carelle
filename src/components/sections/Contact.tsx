          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-slate-400">
                N'hésitez pas à me contacter pour des collaborations, des stages & Alternances
                ou toutes autres opportunités me permettant de mettre en avant mes compétences. Je serais ravi de vous répondre.
                Remplissez le formulaire ou contactez-moi directement par e-mail pour me joindre.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  <p className="text-sm text-slate-500">Mon adresse Email :</p>
              ...
              <div className="flex items-center gap-4 text-slate-300 p-4 bg-slate-800/30 rounded-xl border border-slate-800">
                ...
                <div>
                  ...
                  <p className="font-medium">Lille 59000, France</p>
                </div>
              </div>
            </div>
          </motion.div>
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              {formState === "error" && (
                <div className="flex items-center gap-2 text-red-400 bg-red-400/10 border border-red-400/20 rounded-lg px-4 py-3">
                  ...
                  <span>Échec de l'envoi du message. Veuillez réessayer.</span>
                </div>
              )}
              ...
              >
                {formState === "loading" ? (
                  ...
                  <>
                    Envoyer le message <TbSend size={18} />
                  </>
                )}
              </button>
            </form>
